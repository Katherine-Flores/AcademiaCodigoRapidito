...
@section('title', 'Catedraticos-Table')
...
@section('content')
    ...
    <div class="p-5 table-responsive">
                ...
                <tr>
                    ...
                    <td>
                        <a href="" class="btn btn-warning"
                           data-bs-toggle="modal" data-bs-target="#modalEditar{{$Catedratico->Codigo_Catedratico}}">
                    ...
                    <!-- Modal de editar -->
                    <div class="modal fade" id="modalEditar{{$Catedratico->Codigo_Catedratico}}" tabindex="-1"
        ...
        <div class="d-flex justify-content-center">
            {{ $catedraticos->appends(request()->input())->links() }}
        </div>
    </div>
@stop
