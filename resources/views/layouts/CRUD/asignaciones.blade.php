...
<body>
<h1 class="text-center p-3">Cursos Asignados</h1>
                            ...
                            <div class="modal-body">
                                <form action="{{ route('asignacion.update', $asignacion->Id_Asignacion) }}"
                                    ...
                                    <div class="form-group row mb-3">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="number" name="Codigo_Catedratico" class="form-control"
                                                   value="{{$asignacion->Codigo_Catedratico}}">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-3">
                                        <label class="col-sm-5 col-form-label">Sucursal</label>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        deleteForms.forEach(function (form) {
            form.addEventListener('submit', function (event) {
                var confirmation = confirm('¿Está seguro de que desea eliminar esta asignación?');
                if (!confirmation) {
